...
const Loading = () => {
    return (
        <div role="status" className="animate-pulse md:px-10 flex flex-col">
            ...
            <div className="flex items-center justify-center w-full h-48 md:h-[400px] bg-gray-200 rounded sm:w-full mb-10">
