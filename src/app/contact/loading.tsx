...
const Loading = () => {
    return (
        ...
        <div role="status" className="space-y-8  animate-pulse py-[150px] px-20 flex flex-col">
            ...
            <div className="flex items-center justify-center w-full h-48 bg-gray-300 rounded sm:w-96">
                <svg className="w-10 h-10 text-gray-200" aria-hidden xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
