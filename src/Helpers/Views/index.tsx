...
export const scrollTopView = (
  scrollBtn: React.MutableRefObject<HTMLDivElement | null>,
  scrollTop: () => void
): JSX.Element => {
  return (
  ...
  return (
    <PayPalScriptProvider
      options={{
        ...
        currency: "USD",
        dataClientToken:
          "EAZ_vmzC_Ftt6VoBxwEhZ5iadc6IYsTNqfMGWeuM6Lr027KxaG9E8kGwHNijda9bCvkbafpF3j64KzEd",
        intent: "capture",
      }}
    >
      <PayPalButtons
