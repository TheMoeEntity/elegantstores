...
const Dashboard = ({
  ...
  return (
    <div className="flex my-8 flex-row gap-3 gap-x-7 md:gap-x-3 lg:gap-x-7 flex-wrap mx-auto w-[90%] md:w-[97%] lg:w-[85%]">
      ...
      <div
        className={
          "flex z-10 no-scrollbar left-0 xs:w-[240px] trans h-full overflow-y-scroll overflow-auto top-0 md:w-auto xm:w-[280px] shadow-2xl md:shadow-none basis-[100%] md:relative fixed md:basis-[30%] px-5 py-10 md:h-auto gap-y-9 flex-col bg-[#F3F5F7] " +
          (hideSideBar ? "-translate-x-[100%]" : "translate-x-0")
        }
      >
        <button
          onClick={() => setHideSideBar(!hideSideBar)}
          className="hidden text-4xl absolute top-2 right-3"
        >
          &times;
        </button>
        ...
        <div className="w-24 h-24 relative text-white flex justify-center items-center">
          ...
          <button
            onClick={() => openFiles()}
            className="absolute flex justify-center items-center z-[1] bg-[#FAFAFA] rounded-full w-10 h-10 -right-1 bottom-0"
          >
            ...
            <form className="mt-5 flex md:w-[90%] flex-col gap-[20px] pr-5 pb-12">
              ...
              <div className="">
                ...
                <input
                  ...
                  defaultValue={getSession?.userName}
                  type="text"
                  className="py-[10px] bg-transparent px-[10px] w-full border-gray-300 border-b-[1px]"
                />
              </div>
              ...
              <div className="">
                ...
                <input
                  placeholder="*****"
                  type="password"
                  className="py-[10px] px-[10px] w-full bg-transparent border-gray-300 border-b-[1px]"
                />
              </div>
              <div className="">
                <label htmlFor="" className=" block font-bold mb-2">
              ...
              <div className="flex justify-end">
                <button className="bg-[#171D28] text-white rounded-md w-full h-[54px]">
                  Save changes
                </button>
              </div>
            </form>
              ...
              <div className="min-w-[46%] border-[1px] border-black justify-start items-start rounded-md px-4 py-4 flex flex-col gap-y-5 flex-between">
                <div className="flex justify-between w-full">
                  ...
                  <button
                    ...
                    className={isEditingBilling ? "black" : "text-gray-400"}
                  >
                ...
                <form className="flex flex-col gap-y-4 w-[85%]">
                  <input
                    type="text"
                    readOnly
                    className="border-b-[1px] px-2 bg-transparent py-1 outline-none"
                    name=""
                    defaultValue={getSession?.fullName}
                    id=""
                  />
                  <input
                    ...
                    className="border-b-[1px] outline-none px-2 bg-transparent py-1"
              ...
              <div className="min-w-[46%] border-[1px] border-black justify-start items-start rounded-md px-4 py-4 flex flex-col gap-y-5 flex-between">
                <div className="flex justify-between w-full">
                  ...
                  <button
                    ...
                    className={isEditingShipping ? "black" : "text-gray-400"}
                  >
                    <i className="fas fa-edit mr-2"></i>
                ...
                <form className="flex flex-col gap-y-4 w-[85%]">
                  <input
                    readOnly
                    type="text"
                    className="border-b-[1px] px-2 bg-transparent py-1"
                    name=""
                    defaultValue={getSession?.fullName}
                    id=""
                  />
        ...
        {step === 2 && (
          ...
          >
            ...
            <div className="flex flex-col w-full overflow-x-scroll h-[300px]">
              <table className="min-w-full text-left overflow-x-scroll text-sm   max-w-full font-light text-surface">
                ...
                <tbody>
                  <tr className="border-b border-neutral-200 transition duration-300 ease-in-out hover:bg-neutral-100">
                    ...
                    <td className="whitespace-nowrap px-6 py-4 text-green-800 font-semibold">
                      Delivered
                    </td>
                            ...
                            >
                              ...
                              >
                                <div className="w-full h-[190px] md:min-w-[auto] md:min-h-[160px] flex items-center gap-x-4 md:gap-x-6">
                                  ...
                                  <div className="flex flex-col gap-y-4 justify-center basis-[40%] max-w-[45%]">
                                    <h2 className="font-semibold md:text-xl text-left">
                                      {x.title.slice(0, 15)}...
                                    </h2>
                              ...
                              <td className="px-6 py-5  flex-col text-xl h-[160px] max-w-[100%] items-center justify-center hidden md:table-cell">
                                <div className="flex items-center gap-x-4 border-[1px] justify-between shadow-md w-[120px]">
                                  <button
                                    onClick={() => addAction(x.title)}
                                    className="w-full bg-black text-white rounded-lg text-sm px-2 py-2"
                                  >
                                    Add to cart
                                  </button>
                                </div>
