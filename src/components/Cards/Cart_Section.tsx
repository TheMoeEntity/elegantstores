    ...
    <main className="max-w-7xl mx-auto bg-[#fafafa]">
      ...
      <div className="mx-auto lg:w-[60%] md:w-[90%] md:pl-0 pl-5 flex flex-wrap md:overflow-x-visible overflow-x-scroll justify-center  no-scrollbar">
        <div className="border-[#DEE1E6] text-xl whitespace-nowrap  pb-0.3 mb-[32px] w-full md:w-fit mx-auto flex ">
          <div
            className={`gap-x-3 flex items-center mr-7 text-left px-2 border-b-[2px] pb-2 ${step === 0 ? " border-black " : "text-[#0D141F99] border-transparent"}  w-fit`}
          >
            <span
              className={`w-6 h-6 text-white ${step === 0 ? "bg-black" : "bg-[#0D141F99]"} items-center justify-center flex rounded-full text-xs`}
            >
              1
            </span>
          ...
          <div
            className={`gap-x-3 flex items-center mr-7 text-left px-2 border-b-[2px] pb-2 ${step === 1 ? "border-black" : "text-[#0D141F99] border-transparent"}  w-fit`}
          >
            <span
              className={`w-6 h-6 text-white ${step === 1 ? "bg-black" : "bg-[#0D141F99]"} items-center justify-center flex rounded-full text-xs`}
            >
              2
            </span>
          ...
          <div
            className={`gap-x-3 flex items-center mr-7 text-left px-2 border-b-[2px] pb-2 ${step === 2 ? "border-black" : "text-[#0D141F99] border-transparent"}  w-fit`}
          >
            <span
              className={`w-6 h-6 text-white ${step === 2 ? "bg-black" : "bg-[#0D141F99]"} items-center justify-center flex rounded-full text-xs`}
            >
              3
            </span>
            <button
              disabled={notAuth ? true : orderplaced ? true : false}
              onClick={() => setStep(2)}
            >
              Order complete
            </button>
          ...
          >
                  ...
                  <div className="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                    <div className="overflow-hidden">
                      {cart.length == 0 && (
                        <div
                          className={
                            "flex flex-col items-center mx-auto w-full lg:w-[70%]"
                          }
                        >
                          ...
                          <h4 className="md:text-2xl font-semibold text-center">
                            Darn it, cart is empty.{" "}
                            <Link
                              className="underline md:text-xl text-[#377DFF]"
                              href={"/shop"}
                            >
                              Keep shopping.
                            </Link>
                      ...
                      {cart.length > 0 && (
                        <table className="min-w-full text-left text-sm font-light text-surface border-spacing-5">
                          <thead className="border-b border-neutral-200 bg-white font-semibold">
                            <tr>
                              <th
                                scope="col"
                                className="px-6 py-4 w-[55%]"
                                colSpan={2}
                              >
                                Product
                              </th>
                              <th
                                scope="col"
                                className="px-6 py-4 text-center hidden md:table-cell"
                              >
                                Quantity
                              </th>
                              <th
                          ...
                          <tbody>
                            {cart.map((x) => (
                              <tr
                                key={x.item.id}
                                className="border-b border-neutral-200 border-b-gray-200 h-auto"
                              >
                                <td
                                  className="px-0 min-w-[65%] md:min-w-[55%] md:max-w-[55%] py-0 font-medium align-top"
                                  colSpan={2}
                                >
                                  <div className="w-full h-[190px] md:min-h-[160px] flex items-center gap-x-4 md:gap-x-6">
                                    ...
                                    <div className="flex flex-col gap-y-4 justify-center basis-[40%] max-w-[45%]">
                                      ...
                                      <h2 className="text-sm text-gray-400 text-left whitespace-nowrap">
                                        Color: {x.item.colors[0]} |{" "}
                                        {x.item.sizes[0]}
                                      </h2>
                                      <button
                                        onClick={() => removeAction(x.item.id)}
                                      ...
                                      <div className="flex items-center md:hidden rounded-lg gap-x-4 border-[1px] border-black justify-between py-1 px-3 shadow-md">
                                        ...
                                        <button
                                          onClick={() =>
                                            updateItemQuantity(x.item.id, "add")
                                          }
                                        >
                                          +
                                        </button>
                                ...
                                <td className="px-6 py-5  flex-col text-xl h-[160px] max-w-[100%] items-center justify-center hidden md:table-cell">
                                  <div className="flex items-center rounded-lg gap-x-4 border-[1px] border-black justify-between py-1 px-6 shadow-md w-[120px]">
                                    <button
                                      onClick={() =>
                                        updateItemQuantity(x.item.id, "reduce")
                                      }
                                    >
                                      -
                                    </button>
                                ...
                                <td className="whitespace-nowrap px-6 py-4 text-xl hidden md:table-cell">
                                  ₦
            ...
            {cart.length > 0 && (
              <div className="flex-1 border-[1px] md:w-[60%] max-w-full border-black rounded-md px-4 py-5 flex flex-col gap-y-5">
                ...
                <div
                  className={
                    "flex rounded-md justify-between items-center px-4 border-[1px] border-black trans " +
                    (shippingOptions == 0 && "bg-[#F3F5F7]")
                  }
                >
                  <div className="flex items-center gap-x-3 py-3">
                    ...
                    <button onClick={() => setShippingOptions(0)}>
                      Free Shipping
                    </button>
                  </div>
                  <span>₦0.00</span>
                ...
                >
                  <div className="flex items-center gap-x-3 py-3">
                    ...
                    <button onClick={() => setShippingOptions(1)}>
                      Express shipping
                    </button>
                  </div>
                ...
                >
                  <div className="flex items-center gap-x-3 py-3">
                    ...
                    <button onClick={() => setShippingOptions(2)}>
                      Pick up
                    </button>
                  </div>
                ...
                <div className="flex rounded-md justify-between items-center px-4 border-b-[1px] border-gray-200">
                  <div className="flex gap-x-3 py-3">Subtotal</div>
        ...
        {step === 1 && (
          ...
          >
                    ...
                    <div className="flex flex-col md:flex-row justify-between gap-y-5">
                      <div className="md:w-[48%] flex flex-col">
                        ...
                        <input
                          ...
                          type="text"
                          className="py-[10px] bg-transparent px-[10px] w-full border-gray-300 border-b-[1px]"
                        />
                      </div>
                      <div className="md:w-[48%] flex flex-col">
                      ...
                      <div className="flex flex-col">
                        ...
                        >
                          {allCountries.map((country, i) => (
                            <option key={i}>{country.nameAndSymbol}</option>
                          ))}
                        </select>
                      </div>
                      <div>
                        <div className="w-full mt-3 pt-3 my-0 flex justify-end text-red-700">
                          {loadError}
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center gap-x-3 py-3">
                    <div className="w-4 h-4 flex items-center justify-center border-[1px] rounded-full border-black">
                      <div
                        className={
                          "w-2 h-2 rounded-full trans " +
                          (paymentOption === 1 ? "bg-black" : "bg-transparent")
                        }
                      ></div>
                    </div>
                    <button onClick={() => setPaymentOption(1)}>
                      Stripe (unavailable)
                    </button>
                  </div>
                  <div
                    className={
                      "overflow-hidden trans " +
                      (paymentOption === 1
                        ? "max-h-fit py-1 h-fit"
                        : "max-h-0 h-0 py-0")
                    }
                  >
                  ...
                  <div className="flex items-center gap-x-3 py-3">
                    <div className="w-4 h-4 flex items-center justify-center border-[1px] rounded-full border-black">
                      <div
                        className={
                          "w-2 h-2 rounded-full trans " +
                          (paymentOption === 3 ? "bg-black" : "bg-transparent")
                        }
                      ></div>
                    </div>
                    <button onClick={() => setPaymentOption(3)}>
                  ...
                  <div className="flex items-center gap-x-3 py-3">
                    <div className="w-4 h-4 flex items-center justify-center border-[1px] rounded-full border-black">
                      <div
                        className={
                          "w-2 h-2 rounded-full trans " +
                          (paymentOption === 4 ? "bg-black" : "bg-transparent")
                        }
                      ></div>
                    </div>
                    <button onClick={() => setPaymentOption(4)}>
                      Pay on delivery
                    </button>
                  </div>
                </div>
            ...
            <div className="border-[1px] border-black h-fit rounded-md px-4 py-5 flex flex-col gap-y-5 md:min-w-[39%] lg:min-w-[30%]">
              ...
              {cart.map((x, i) => (
                <div key={i} className="flex items-between">
                    ...
                    <div className="w-full h-[190px] md:h-[160px] flex items-center gap-x-4 md:gap-x-6">
                      ...
                      <div className="flex flex-col gap-y-4 justify-center basis-[40%] max-w-[45%]">
                        ...
                        <div className="flex items-center md:hidden rounded-lg gap-x-4 border-[1px] border-black justify-between py-1 px-3 shadow-md">
                          ...
                          <span className="font-extrabold">{x.quantity}</span>
                          <button
                            onClick={() => updateItemQuantity(x.item.id, "add")}
                          >
                            +
                          </button>
                        </div>
                  ...
                  <div className="whitespace-nowrap align-middle pl-8 pt-10 text-xl table-cell text-center">
                    ...
                    <br />
                    <span className="mt-5 md:hidden text-3xl block">
                      &times;
                    </span>
                  </div>
                </div>
              ...
              <hr />
              <form
                onSubmit={(e) => couponAction(e)}
                className="flex gap-x-3 w-full items-between justify-between"
              >
                <input
                  placeholder="coupon code"
                  type="text"
                  readOnly={notAuth ? true : cart.length === 0 ? true : false}
                  className="py-2 border-[1px] outline-none rounded-md pl-2 w-[60%]"
                />
                <button
                  type="submit"
                  className="bg-black text-white w-[35%] rounded-md py-2 disabled:bg-slate-300"
                  disabled={notAuth ? true : cart.length === 0 ? true : false}
                >
                  Apply
                </button>
              </form>
              ...
              <div className="flex rounded-md justify-between items-center px-4 border-b-[1px] border-gray-200">
                ...
                <span>₦{(total + produceExtraCost()).toLocaleString()}</span>
              </div>
              <div>
                <button
                  disabled={notAuth ? true : cart.length === 0 ? true : false}
                  className="bg-black text-white w-full py-3 rounded-md disabled:bg-slate-300"
                >
                  Place order
                </button>
              </div>
