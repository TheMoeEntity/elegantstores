      ...
      <div className="w-full h-auto flex flex-col md:flex-row mb-7">
        ...
        <div className="bg-[#F3F5F7] md:w-[50%]  md:flex-[50%] text-black px-6 py-12 md:px-12 flex flex-row justify-center items-center">
          <div className="flex flex-col gap-5">
            ...
            <h1 className="text-4xl md:text-[52px] w-[60%] md:w-[90%] leading-tight">
              HUNDREDS of New lower prices!.
            </h1>
            <p className="leading-loose md:w-[70%]">
              Hurry up!!! Winter is coming!
            </p>
            <button className="rounded-lg text-black w-fit underline underline-offset-8 py-3 ">
              Shop now! &rarr;
            </button>
          </div>
        </div>
      ...
      <div className="flex flex-row md:flex-row md:gap-5 gap-0 justify-center flex-wrap mb-7 w-[90%] md:w-[95%] mx-auto">
        {insta &&
          insta.slice(10, 14).map((x, i) => (
            <div
              key={i}
              className="flex basis-full w-auto md:min-h-fit flex-col gap-3 h-fit min-w-full md:min-w-[10%] md:basis-[20%] lg:basis-[23%]"
            >
