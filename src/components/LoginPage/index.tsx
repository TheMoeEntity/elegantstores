...
const LoginPage = () => {
    ...
    useEffect(() => {
        ...
        } else if (notAuth === "true") {
            enqueueSnackbar({
                message: "You need to be signed in to access account",
                variant: 'info'
            })
        }
    }, [verify,notAuth])
        ...
        <section className='w-full h-auto flex flex-col md:flex-row'>
            ...
            <div className="bg-[#ffff] md:w-[50%]  md:flex-[50%] text-gray-700 px-6 py-12 md:px-12 flex flex-row items-center">
                <div className='flex flex-col gap-5 w-full'>
                    ...
                    <form onSubmit={e => Helpers.validateLoginForm(e, setStatus, toast,)} className="mt-5 flex md:w-[90%] flex-col gap-[20px] pb-12">
                        <div className="">
